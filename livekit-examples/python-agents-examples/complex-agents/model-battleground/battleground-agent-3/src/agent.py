...
AGENT_ID: Final = "agent-3"
DEFAULT_STT_LABEL: Final = "STT (deepgram/nova-3-general)"
DEFAULT_LLM_LABEL: Final = "LLM (moonshotai/kimi-k2-instruct)"
DEFAULT_TTS_LABEL: Final = "TTS (rime/arcana)"
...
if __name__ == "__main__":
    cli.run_app(WorkerOptions(entrypoint_fnc=entrypoint, agent_name="devday-battleground-agent-3", prewarm_fnc=prewarm))
