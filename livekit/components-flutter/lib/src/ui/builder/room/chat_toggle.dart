...
class ChatToggle extends StatelessWidget {
  ...
  final Widget Function(BuildContext context, RoomContext roomCtx, bool isChatEnabled) builder;
  ...
  Widget build(BuildContext context) {
    return Consumer<RoomContext>(builder: (context, roomCtx, child) {
      return Selector<RoomContext, bool>(
        ...
        builder: (context, isChatEnabled, child) => builder(context, roomCtx, isChatEnabled),
      );
    });
  }
}
